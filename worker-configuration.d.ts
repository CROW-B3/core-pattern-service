/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 73778620465cc0db39c5cbd0d798ccd5)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    API_GATEWAY_URL: 'https://dev.api.crowai.dev' | 'http://localhost:8000';
    AUTH_SERVICE_URL?: 'https://dev.internal.auth-api.crowai.dev';
    PATTERN_CONTAINER: DurableObjectNamespace<
      import('./src/worker').PatternAnalyzerContainer
    >;
